package com.example.mc_assignment_03;
...
public class DbHandler extends  SQLiteOpenHelper {
    ...
    public void insertStudent(com.example.mc_assignment_03.Student student) {
    ...
    public List<com.example.mc_assignment_03.Student> selectAllStudents() {
        List<com.example.mc_assignment_03.Student> students = new ArrayList<>();
        String sql = "SELECT * FROM " + TABLE_NAME;
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(sql, null);
        if (cursor.moveToFirst()) {
            do {
                students.add(new com.example.mc_assignment_03.Student(cursor.getInt(0),
                        cursor.getString(1),
    ...
    public void insertRecord(com.example.mc_assignment_03.Record record) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public ArrayList<com.example.mc_assignment_03.Record> selectAllRecords(Integer id) {
        ArrayList<com.example.mc_assignment_03.Record> records = new ArrayList<>();
        String sql = "SELECT * FROM " + REC_TABLE_NAME +" where std_id="+id;
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery(sql, null);
        if (cursor.moveToFirst()) {
            do {
                records.add(new com.example.mc_assignment_03.Record(cursor.getInt(0),cursor.getInt(1),
