...
public class MainActivity extends AppCompatActivity {
    Button btn_add_std, btn_show_records, btn_add_record;
    DbHandler dbHandler;
    Button git_link;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_show_records= findViewById(R.id.btn_see_records);
        ...
        git_link.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Uri webpage = Uri.parse("https://github.com/tk34395/MC-Assignment_03/commits/main");
